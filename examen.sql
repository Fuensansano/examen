...
INSERT INTO `admins` (`id`, `name`, `email`, `password`, `status`, `deleted`, `login_at`, `created_at`, `updated_at`, `deleted_at`) VALUES
    ...
    (5, 'fuen', 'fuen@fuen.com', 'a433ae700caec38451ff2f7b6ec328dd6d2400fef007b20f574bde70037080ca97e033985b05fc3a9b8dbd248849f12724e4ba551ad0c447658a22c01ab5e53c', 1, 0, '2022-10-30 18:12:41', '2022-10-17 17:16:14', NULL, NULL);
...
CREATE TABLE `products` (
    ...
    `updated_at` datetime DEFAULT NULL,
    `deleted_at` datetime DEFAULT NULL,
    `author` varchar(200) CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT NULL,
    `publisher` varchar(200) CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT NULL,
    `pages` int DEFAULT NULL,
    `people` text CHARACTER SET latin1 COLLATE latin1_spanish_ci,
    `objetives` text CHARACTER SET latin1 COLLATE latin1_spanish_ci,
    `necesites` text CHARACTER SET latin1 COLLATE latin1_spanish_ci
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
...
INSERT INTO `users` (`id`, `first_name`, `last_name_1`, `last_name_2`, `email`, `address`, `city`, `state`, `zipcode`, `country`, `password`) VALUES
      ...
      (3, 'Dolores', 'Hernández', 'Martinez', 'lola@lolita.com', 'C/ dolores 4', 'Madrid', 'Madrid', '24588', 'España', '806cc6e9290ccac7e77a34f545b28fdf3c8a87dab0f144f3885b2411483e433df0a34d9d11355f20b74df86b9bbbe5dd95d4046be9430851b8fbdbc390dc8e54');
    --
